...
export default {
    ...
    getOtaList(params, callback) {
        RequestService.sendRequest()
            .url(`${getManagerServiceUrl()}/otaMag`)
            .method('GET')
            .data(params)
            .success((res) => {
    ...
    getOtaInfo(id, callback) {
        RequestService.sendRequest()
            .url(`${getManagerServiceUrl()}/otaMag/${id}`)
            .method('GET')
            .success((res) => {
                RequestService.clearRequestTime();
                callback(res);
    ...
    uploadFirmware(file, callback) {
        ...
        RequestService.sendRequest()
            .url(`${getManagerServiceUrl()}/otaMag/upload`)
            .method('POST')
            .data(formData)
            .success((res) => {
                RequestService.clearRequestTime();
    ...
    getDownloadUrl(id, callback) {
        RequestService.sendRequest()
            .url(`${getManagerServiceUrl()}/otaMag/getDownloadUrl/${id}`)
            .method('GET')
            .success((res) => {
                RequestService.clearRequestTime();
                callback(res);
